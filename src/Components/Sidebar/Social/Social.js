...
function Social() {
    ...
    return (
        <div className="Social">
            ...
            <div><a href="https://t.me/khardy209" target="_blank" rel="noreferrer"><img className='icons' width="36px" src="./icons/telegram.svg" alt="telegram"/> Telegram</a></div>
            <div><a href="mailto:kyrychenko.dmytro.v@gmail.com" target="_blank" rel="noreferrer"><img className='icons' width="36px" src="./icons/mail.svg" alt="mail" target="_blank" /> Gmail</a></div>
            <div><a href="https://join.skype.com/invite/DRJld7GE4cBW" target="_blank" rel="noreferrer"><img className='icons' width="36px" src="./icons/skype.svg" alt="skype" /> Skype</a></div>
            ...
            <div><a href="https://github.com/KyrychenkoDmytro" target="_blank" rel="noreferrer"><img className='icons' width="36px" src="./icons/github.svg" alt="github" /> Git</a></div>
