...
function Social() {
    ...
    return (
        <div className="Social">
            ...
            <div><a href="https://www.linkedin.com/in/dmytro-kyrychenko-b33b54243/"><img className='icons' width="36px" src="./icons/linkedin.svg" alt="linkedin" /> {data.linkedin}</a></div>
            ...
            <div><a href="https://www.codewars.com/users/khardy-official/badges/large"><img className='icons' width="36px" src="./icons/codewars.svg" alt="github" /> Codewars</a></div>
